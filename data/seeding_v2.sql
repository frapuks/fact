...
INSERT INTO product(label, price, tax_id) VALUES 
('Lot de 20 pierres de taille', 2312, 1),
('Esclave', 500, 2),
('Petit géranium', 43.2, 1),
('Strychnine (1L)', 32, 1),
('Arsenic (1L)', 35, 2),
('Bave de sangsue (20CL)', 12.5, 1),
('Scorpion séché', 7, 2),
('Branche de gui', 19, 1),
('Barquette de fraises', 39.5, 1),
('Cèpes (500G)', 48, 2);
